...
async def _ai_reply(prompt: str, lang: str) -> str:
    ...
    try:
        ...
        system_msg = "أنت مساعد ذكي ومختصر. أجب باختصار وبنفس لغة المستخدم." if lang == AR else "You are a smart and concise assistant. Answer briefly in the user's language."
